    ...
    <div class="container-fluid">
        ...
        <div class="col-xl-3 col-md-6">
            ...
            <!-- Card body -->
                <div class="card-body">
                    <div class="row">
                    <div class="col">
                        <h6 class="card-title text-uppercase text-muted mb-0">Total Products</h6>
        ...
        <div class="col-xl-3 col-md-6">
            ...
            <div class="card-body">
                ...
                <div class="col">
                    ...
                    <span class="h2 font-weight-bold mb-0">
                      @if($allprofit->sum->purchase_qty > 0 ) 
                            {{ number_format($allprofit->sum->purchase_qty ?? '' , 0, ',', '.') }}
                      @else
                            0.00
                      @endif  
                    </span>
                ...
                <p class="mt-3 mb-0 text-sm">
                <span class="text-success mr-2"><i class="fa fa-arrow-up"></i>
                      @if($salesmonthly->sum->purchase_qty > 0 ) 
                            {{ number_format($salesmonthly->sum->purchase_qty ?? '' , 0, ',', '.') }}
                      @else
                            0.00
                      @endif
                </span>
        ...
        <div class="col-xl-3 col-md-6">
            ...
            <div class="card-body">
                ...
                <p class="mt-3 mb-0 text-sm">
                <span class="text-success mr-2"><i class="fa fa-arrow-up"></i>
                      @if($profitmonthly->sum->total > 0 ) 
                            {{ number_format($profitmonthly->sum->total ?? '' , 0, ',', '.') }}
                      @else
                            0.00
                      @endif</span>
                <span class="text-nowrap">Since this month</span>
          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Newly Products</h3>
                </div>
        ...
        <div class="col-xl-4">
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Sales for today</h3>
