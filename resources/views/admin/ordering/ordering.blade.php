    ...
    <div class="container-fluid">
        <div class="header-body">
            <div class="row align-items-center py-4">
                ...
                <h6 class="h2 text-white d-inline-block mb-0">Choose A Products</h6>
                    ...
                    <span id="form_result"></span>      
                        ...
                        <!-- Card body -->
                            <div class="card-body">
                                <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0" id="name"></h5>
                                    <large class="text-success font-weight-bold mr-1">₱</large><span class="h2 font-weight-bold mb-0" id="price"></span>
                                </div>
                                <div class="col-auto">
                                ...
                                <span class="text-success mr-2 font-weight-bold" id="size"></span>
                                <span class="text-success mr-2 font-weight-bold" id="stock"></span>
                                <br>
                                <span class="text-nowrap font-weight-bold " id="expiration"></span>
                                </p>
                            </div>
                        </div>
                        <div class="card card-stats" style="border-bottom: 1px solid #111">
    ...
    success:function(data){
        ...
        $.each(data.result, function(key,value){
            if(key == $('#'+key).attr('id')){
                ...
                if(key == 'price'){
                    $('#price').html(formatter.format(value));
                }
                if(key == 'size'){
                    $('#size').text(value);
                }
                if(key == 'stock'){
                    $('#stock').text('/  Stock: '+value);
                }
                if(key == 'expiration'){
                    $('#expiration').text('Expiration: '+value);
                }
            }
        })
        $('#hidden_id').val(id);
