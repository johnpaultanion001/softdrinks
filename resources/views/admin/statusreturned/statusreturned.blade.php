...
@section('sub-title','Status of return')
@section('navbar')
...
$(document).on('click', '.edit', function(){
    ...
    $.ajax({
        url :"/admin/status-return/"+id+"/edit",
        dataType:"json",
        beforeSend:function(){
...
$('#myForm').on('submit', function(event){
    ...
    $('.form-control').removeClass('is-invalid')
    var action_url = "{{ route('admin.status-return.store') }}";
    var type = "POST";

    if($('#action').val() == 'Edit'){
        var id = $('#hidden_id').val();
        action_url = "status-return/" + id;
        type = "PUT";
    }
