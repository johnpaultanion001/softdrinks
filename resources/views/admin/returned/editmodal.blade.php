            ...
            <table class="table align-items-center table-flush datatable-editreturnproducts">
                ...
                <tbody class="text-uppercase font-weight-bold">
                    @foreach($returnedproducts as $key => $product)
                        ...
                        <td>
                          <button type="button" name="editproduct" editproduct="{{  $product->id ?? '' }}"  class="editproduct text-uppercase btn btn-info btn-sm">Edit</button>
                          <button type="button" name="removeproduct" removeproduct="{{  $product->id ?? '' }}" id="{{  $product->id ?? '' }}" class="removeproduct text-uppercase btn btn-danger btn-sm">Remove</button>
                        </td>
                        <td>
                            {{  $product->name ?? '' }}
                        </td>
...
$(function () {
  ...
  $('.datatable-editreturnproducts:not(.ajaxTable)').DataTable({ buttons: dtButtons })
